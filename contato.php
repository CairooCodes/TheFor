        ...
        <div class="lg:w-full pt-20 pb-8 mx-auto lg:pb-16">
            <div class="pb-8 shadow-inner bg-white bg-opacity-70 shadow-md rounded-xl">
                <div class="max-w-screen-xl px-4 pt-8 mx-auto mb-3 text-center">
                    ...
                    <h1 class="mt-5 text-red-800 font-semibold lg:text-4xl text-xl">
                        Fale Conosco
                    </h1>
                    <h2 class="mt-5 text-red-800 font-semibold lg:text-2xl text-xl">
                    ...
                    <div class="p-4">
                        <div class="lg:w-2/3 px-4 pb-8 mx-auto lg:pb-16">
                            ...
                            <div class="flex justify-center">
                                <button type="submit" class="text-white bg-red-800  hover:bg-red-500 mt-5 w-52 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Enviar Formulário</button>
                            </div>
                        </div>
                </form>
            </div>
