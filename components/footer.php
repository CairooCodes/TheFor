<footer class="mt-8 shadow-inner bg-color2">
	<div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
		<div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
			<div>
				...
				<div class="mt-8 flex space-x-6 text-white">
					...
					<a class="hover:opacity-75" href="https://www.instagram.com/theforvigilantes/" target="_blank" rel="noreferrer">
					...
					<a class="hover:opacity-75" href="https://api.whatsapp.com/send?phone=558699742045" target="_blank" rel="noreferrer">
						<span class="sr-only"> WhatsApp </span>
						<svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
			...
			<div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-3">
				...
				<div>
					<p class="font-medium text-white">MAIS INFORMAÇÕES</p>
					<nav class="mt-4 flex flex-col space-y-2 text-sm text-white">
		...
		<p class="mt-12 text-xs text-white text-center">
			Todos os direitos reservados <br>©cairocodes 2023
		</p>
	</div>
</footer>