  ...
  <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
    ...
    <div class="max-w-7xl px-4 pb-8 mx-auto py-8">
      <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <form action="./controllers/edit_documento.php?id=<?php echo $documento['id']; ?>" method="POST" enctype="multipart/form-data" class="relative bg-white rounded-lg shadow">
          <!-- Modal header -->
          ...
          <div class="p-6 space-y-6">
            <div class="grid grid-cols-6 gap-6">
              <div class="col-span-6 sm:col-span-3">
                ...
                <input name="name" type="text" value="<?php echo $documento['name']; ?>" id="name" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" placeholder="Título para os documentos" required="">
              </div>
              <input id="id" name="id" type="hidden" value="<?php echo $documento['id']; ?>">
            </div>
            <textarea name="descritpion" id="descritpion" type="text"><?php echo $documento['descritpion']; ?></textarea>
            <!-- Modal footer -->
