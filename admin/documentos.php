...
<head>
  <title>Documentação - THEFOR</title>
  <meta charset="UTF-8">
            ...
            <div>
              <div id="dropdownAction" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
                <ul class="py-1 text-sm text-gray-700" aria-labelledby="dropdownActionButton">
                  <li>
                    <button data-modal-target="addDocumentoModal" data-modal-show="addDocumentoModal" class="block px-4 py-2 hover:bg-gray-100">Adicionar Documento</button>
                  </li>
                  <li>
          ...
          <tbody>
            <?php foreach ($documentos as $documento) { ?>
                ...
                <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap">
                  <div class="pl-3">
                    <div class="text-base font-semibold"><?php echo $documento['name']; ?></div>
                  </div>
                </th>
                <td class="px-6 py-4">
                  <a href="./editar_documento.php?id=<?php echo $documento['id']; ?>" type="button" class="font-medium text-blue-600 hover:underline">Editar</a>
                  <a href="./controllers/delete_documento.php?id=<?php echo $documento['id']; ?>" type="button" class="font-medium text-red-600 hover:underline">Excluir</a>
                </td>
              </tr>
            <?php } ?>
          </tbody>
        </table>
        <?php include "./components/modal_add_documento.php"; ?>
      </div>
    </div>
  </div>
  <script>
