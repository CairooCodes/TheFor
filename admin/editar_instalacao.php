  ...
  <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
    ...
    <div class="max-w-7xl px-4 pb-8 mx-auto py-8">
      <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <form action="./controllers/edit_instalacao.php?id=<?php echo $instalacao['id']; ?>" method="POST" enctype="multipart/form-data" class="relative bg-white rounded-lg shadow">
          <!-- Modal header -->
          ...
          <div class="p-6 space-y-6">
            <div class="grid grid-cols-6 gap-6">
              <div class="col-span-6 sm:col-span-3">
                ...
                <input name="name" type="text" value="<?php echo $instalacao['name']; ?>" id="name" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" placeholder="Nome do Produto" required="">
              </div>
              <input id="id" name="id" type="hidden" value="<?php echo $instalacao['id']; ?>">
              <div class="col-span-6 sm:col-span-3">
                <label for="phone-number" class="block mb-2 text-sm font-medium text-gray-900">Imagem</label>
                <input type="file" id="img" name="img">
              </div>
            </div>
            <textarea name="description" id="description" type="text"><?php echo $instalacao['description']; ?></textarea>
          </div>
